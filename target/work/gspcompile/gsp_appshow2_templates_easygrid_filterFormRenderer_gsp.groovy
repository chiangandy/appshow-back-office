...
class gsp_appshow2_templates_easygrid_filterFormRenderer_gsp extends GroovyPage {
...
printHtmlPart(4)
for( _it1023959594 in (gridConfig.filterForm.fields) ) {
changeItVariable(_it1023959594)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1404720976000L
