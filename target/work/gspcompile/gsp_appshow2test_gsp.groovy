...
class gsp_appshow2test_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/test.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('meta','g',89,['name':("app.version")],-1)
printHtmlPart(7)
invokeTag('meta','g',90,['name':("app.grails.version")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1415179244000L
