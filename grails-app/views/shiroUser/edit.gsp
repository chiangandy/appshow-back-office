...
<html>
	...
	<body>
		<a href="#edit-shiroUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-shiroUser" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:shiroUserInstance, action:'update']" method="PUT" >
